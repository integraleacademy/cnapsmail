...
def send_email_notification(user_email, user_name):
    ...
    try:
        ...
        msg_to_user["Subject"] = "Confirmation de dépôt de dossier - Intégrale Academy"
        msg_to_user["From"] = smtp_user
        msg_to_user["To"] = user_email
        msg_to_user.set_content(f"""Bonjour {user_name},\n\nNous avons bien reçu votre dossier. Il est en cours de traitement.\n\nMerci pour votre confiance,\nL’équipe Intégrale Academy.""")
        ...
        <html>
          <body style='font-family: Arial, sans-serif; color: #333;'>
            <div style='max-width: 600px; margin: auto; border: 1px solid #ccc; padding: 20px; border-radius: 10px;'>
              <h2 style='color: #2e7d32;'>✅ Dossier bien reçu</h2>
              <p>Bonjour <strong>{user_name}</strong>,</p>
              <p>Nous vous confirmons la bonne réception de votre dossier pour la demande d’autorisation CNAPS.</p>
              <p>Notre équipe va désormais procéder à l’étude de votre dossier. Vous recevrez un retour dès qu’il sera traité.</p>
              <p>En cas de question, n’hésitez pas à nous contacter à <a href='mailto:ecole@integraleacademy.com'>ecole@integraleacademy.com</a>.</p>
